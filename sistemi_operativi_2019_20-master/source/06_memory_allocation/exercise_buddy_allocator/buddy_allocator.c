...
void BuddyAllocator_initSingleBuffer(BuddyAllocator* b_allocator_,
  ...
  //!      c   c   c   c     L2
  //!
  //! Pool-allocator-required-memory = N * (sizeof(PAElement) + sizeof(int))
  //! total_memory_buffer[ *********** | ------------------------------------------- ]
  //! total_nodes = 2^(num_levels + 1) - 1
  ...
  //! total_memory_buffer[ *********** | ------------------------------------------- ]
  //!                      |
  //!           list_start = allocator_memory_[0]
  PoolAllocatorResult init_result =
  ...
  //! total_memory_buffer[ *********** | ------------------------------------------- ]
  //!                                    |
  //!               allocator_memory_[0] + internal_memory_required
